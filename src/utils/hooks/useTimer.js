...
var useTimer = function (_a) {
  ...
  var _j = (0, react_1.useState)(0),
    passedTime = _j[0],
    setPassedTime = _j[1];
  var _k = (0, react_1.useState)("00:00:00"),
    passedTimeDisplay = _k[0],
    setPassedTimeDisplay = _k[1];
  var _l = (0, react_1.useState)(0),
    passedSeconds = _l[0],
    setPassedSeconds = _l[1];
  var _m = (0, react_1.useState)(0),
    passedMinutes = _m[0],
    setPassedMinutes = _m[1];
  ...
  var _r = (0, react_1.useState)(false),
    started = _r[0],
    setStarted = _r[1];
  var msToHMS = (0, react_1.useCallback)(
    function (ms) {
  ...
  var minToHMS = (0, react_1.useCallback)(
    function (time) {
      return msToHMS(time * 60 * delay);
    },
    [delay, msToHMS],
  );
  ...
  var start = (0, react_1.useCallback)(
    function start() {
      var _a, _b;
      if (timer.current) {
        stop();
      ...
      var _c =
          (_b =
            (_a = minToHMS(duration || 0)) === null || _a === void 0
              ? void 0
  ...
  (0, react_1.useEffect)(
    function () {
      var _a = displayedTime.split(":").map(function (e) {
          return parseInt(e);
        }),
        hours = _a[0],
        minutes = _a[1],
  ...
  (0, react_1.useEffect)(
    function () {
      ...
      var _a = passedTimeDisplay.split(":").map(function (e) {
          return parseInt(e);
        }),
        hours = _a[0],
        minutes = _a[1],
